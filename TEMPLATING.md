...
* Preserving white space / empty fields - Blank fields may be used to represent new lines or white space in reports. The user may want to preserve this white space to keep the integrity of the original report. To preserve this white space, the spec string should end with an &. This can be combined and often will be with the multiple value extraction, either &* or *& is supported.<br> 
  Example: ``OBX.5 *&`` , ``OBX.5 &*``
